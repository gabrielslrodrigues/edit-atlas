...
class FrameRate final {
 public:
  ...
  [[nodiscard]] static std::expected<FrameRate, FrameRateError> Create(
...
class Timecode final {
 public:
  ...
  [[nodiscard]] static std::expected<Timecode, TimecodeError> Create(
  ...
  [[nodiscard]] static std::expected<Timecode, TimecodeError> FromFrameCount(
...
class TimecodeRange final {
 public:
  ...
  [[nodiscard]] static std::expected<TimecodeRange, TimecodeRangeError> Create(
