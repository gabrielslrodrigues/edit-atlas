...
class FormatRegistry final {
 public:
  ...
  [[nodiscard]] std::expected<void, FormatRegistrationError> RegisterImporter(
      std::unique_ptr<Importer> importer);

  /// Consumes an exporter and registers it when its descriptor is valid.
  [[nodiscard]] std::expected<void, FormatRegistrationError> RegisterExporter(
