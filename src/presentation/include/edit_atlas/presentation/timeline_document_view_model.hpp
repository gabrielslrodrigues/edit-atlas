...
class TimelineDocumentViewModel final : public QObject {
 ...
 public:
  ...
  TimelineDocumentViewModel& operator=(const TimelineDocumentViewModel&) =
      delete;
  ...
  [[nodiscard]] TimelineDocumentCommandResult Import(
  ...
  [[nodiscard]] TimelineDocumentCommandResult SetEventProjection(
  ...
  [[nodiscard]] TimelineDocumentCommandResult Export(
  ...
  [[nodiscard]] std::span<const core::Diagnostic> ImportDiagnostics(
      void) const noexcept;
  /// Returns the most recent import failure, or null after success or clear.
  [[nodiscard]] const services::TimelineDocumentImportFailure* ImportFailure(
      void) const noexcept;
  /// Returns the currently configured filter query.
  [[nodiscard]] const services::TimelineFilterQuery& FilterQuery(
      void) const noexcept;
  /// Returns source-document event indices selected by the active filter.
  [[nodiscard]] std::span<const std::size_t> EventSelection(
      void) const noexcept;
  /// Returns the active filter error, or null when the filter is valid.
  [[nodiscard]] const services::TimelineFilterError* FilterError(
      void) const noexcept;
  ...
  [[nodiscard]] const services::TimelineRenderedVideoExportResult* ExportResult(
      void) const noexcept;
