...
class TimelineFilterModel final : public QAbstractListModel {
  ...
  Q_PROPERTY(
      int combination READ Combination WRITE SetCombination NOTIFY queryChanged)
  ...
  Q_PROPERTY(
      QStringList trackKindNames READ TrackKindNames NOTIFY displayTextChanged)
  /// Localized names for the available edit types.
  Q_PROPERTY(
      QStringList editTypeNames READ EditTypeNames NOTIFY displayTextChanged)
