...
class TimelineTemplateViewModel final : public QObject {
 ...
 public:
  ...
  TimelineTemplateViewModel& operator=(const TimelineTemplateViewModel&) =
      delete;
  ...
  [[nodiscard]] TimelineTemplateCommandResult SetEventProjection(
  ...
  [[nodiscard]] TimelineTemplateCommandResult DuplicateActive(std::string name);
  ...
  [[nodiscard]] std::span<const services::TimelineTemplate> Templates(
      void) const noexcept;
  /// Returns the Qt item model presenting the template choices.
  [[nodiscard]] TimelineTemplateModel& TemplateModel(void) noexcept;
  /// Returns the Qt item model presenting the template choices.
  [[nodiscard]] const TimelineTemplateModel& TemplateModel(void) const noexcept;
  /// Returns the active template identifier, or no value when none is active.
  [[nodiscard]] const std::optional<std::string>& ActiveIdentifier(
      void) const noexcept;
  /// Returns the active template, or null when none is active.
  [[nodiscard]] const services::TimelineTemplate* ActiveTemplate(
      void) const noexcept;
 ...
 private:
  [[nodiscard]] TimelineTemplateCommandResult ValidateWritableState(void) const;
