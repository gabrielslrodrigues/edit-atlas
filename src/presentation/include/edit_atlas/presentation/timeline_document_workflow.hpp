...
class TimelineDocumentWorkflow final : public QObject {
 ...
 public:
  ...
  TimelineDocumentWorkflow& operator=(const TimelineDocumentWorkflow&) = delete;
  ...
  [[nodiscard]] services::TimelineDocumentExportResult ExportResult(void) const;
  ...
  [[nodiscard]] services::TimelineDocumentImportResult ImportResult(void) const;
