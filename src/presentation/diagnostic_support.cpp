...
[[nodiscard]] std::vector<std::string> FormatIdentifiers(
    std::vector<core::FormatDescriptor> formats) {
...
std::filesystem::path ConfiguredLogDirectory(void) {
  return support::ApplicationLogDirectory(ConfiguredApplicationDataDirectory());
}

support::DiagnosticEnvironment CreateDiagnosticEnvironment(
