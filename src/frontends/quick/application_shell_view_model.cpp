...
ApplicationShellViewModel::ApplicationShellViewModel(
    ...
    : QObject{parent},
      ...
      document_view_model_{registry_},
      ...
      application_information_{registry_},
      support_bundle_{registry_} {
  ...
  connect(&document_view_model_,
          ...
          &ApplicationShellViewModel::handleDocumentStateChanged);
  connect(&document_view_model_,
...
SpreadsheetExportViewModel* ApplicationShellViewModel::SpreadsheetExport(
    void) noexcept {
...
SupportBundleViewModel* ApplicationShellViewModel::SupportBundle(
    void) noexcept {
