...
TimelineConfigurationViewModel::TimelineConfigurationViewModel(
    ...
    : QObject{parent},
      document_view_model_{document_view_model},
  ...
  connect(&event_projection_model_,
          &presentation::TimelineEventProjectionModel::projectionChanged, this,
  ...
  connect(&template_view_model_,
          &presentation::TimelineTemplateViewModel::activeTemplateChanged, this,
          &TimelineConfigurationViewModel::handleTemplateStateChanged);
  connect(&template_view_model_,
...
QAbstractItemModel* TimelineConfigurationViewModel::TemplateModel(
    void) noexcept {
  return &template_view_model_.TemplateModel();
}

QAbstractItemModel* TimelineConfigurationViewModel::EventProjectionModel(
    void) noexcept {
...
bool TimelineConfigurationViewModel::HandleTemplateCommandResult(
  ...
  if (const auto* service_failure =
    ...
    switch (
        std::get<presentation::TimelineTemplateCommandError>(result.error())) {
