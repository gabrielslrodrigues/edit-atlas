...
class ApplicationShellViewModel final : public QObject {
  ...
  Q_PROPERTY(
      qulonglong eventCount READ EventCount NOTIFY documentPresentationChanged)
  ...
  Q_PROPERTY(SupportBundleViewModel* supportBundle READ SupportBundle CONSTANT)
 ...
 public:
  ...
  ApplicationShellViewModel(const core::FormatRegistry& registry,
  ...
  ApplicationShellViewModel& operator=(const ApplicationShellViewModel&) =
      delete;
  ...
  [[nodiscard]] TimelineConfigurationViewModel* TimelineConfiguration(
      void) noexcept;
  ...
  [[nodiscard]] ApplicationInformationViewModel* ApplicationInformation(
      void) noexcept;
 ...
 private:
  ...
  void StartImport(const QString& path, std::optional<std::string> frame_rate);
