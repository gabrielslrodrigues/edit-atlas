...
class TimelineConfigurationViewModel final : public QObject {
  ...
  Q_PROPERTY(QAbstractItemModel* eventProjectionModel READ EventProjectionModel
                 CONSTANT)
  Q_PROPERTY(
      int activeTemplateRow READ ActiveTemplateRow NOTIFY templateStateChanged)
  Q_PROPERTY(
      bool hasActiveTemplate READ HasActiveTemplate NOTIFY templateStateChanged)
  Q_PROPERTY(
      bool templateModified READ IsTemplateModified NOTIFY templateStateChanged)
  Q_PROPERTY(QString activeTemplateName READ ActiveTemplateName NOTIFY
                 templateStateChanged)
  Q_PROPERTY(QString templateOperationErrorText READ TemplateOperationErrorText
  ...
  Q_PROPERTY(int eventProjectionSelectedCount READ EventProjectionSelectedCount
 ...
 public:
  ...
  TimelineConfigurationViewModel(const TimelineConfigurationViewModel&) =
      delete;
  TimelineConfigurationViewModel& operator=(
      const TimelineConfigurationViewModel&) = delete;
  TimelineConfigurationViewModel(TimelineConfigurationViewModel&&) = delete;
  TimelineConfigurationViewModel& operator=(TimelineConfigurationViewModel&&) =
      delete;
