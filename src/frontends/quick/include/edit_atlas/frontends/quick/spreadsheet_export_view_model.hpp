...
class SpreadsheetExportViewModel final : public QObject {
 ...
 public:
  ...
  SpreadsheetExportViewModel& operator=(const SpreadsheetExportViewModel&) =
      delete;
  ...
  SpreadsheetExportViewModel& operator=(SpreadsheetExportViewModel&&) = delete;
  ...
  Q_INVOKABLE bool Start(const QUrl& destination,
                         ...
                         const QUrl& rendered_video, bool replace_existing);
