...
class ApplicationInformationViewModel final : public QObject {
  ...
  Q_PROPERTY(
      QString videoBackendConfiguration READ VideoBackendConfiguration CONSTANT)
 ...
 public:
  ...
  explicit ApplicationInformationViewModel(const core::FormatRegistry& registry,
  ...
  ApplicationInformationViewModel& operator=(
      const ApplicationInformationViewModel&) = delete;
  /// Information adapters are non-movable QObject owners.
  ApplicationInformationViewModel(ApplicationInformationViewModel&&) = delete;
  /// Information adapters are non-move-assignable QObject owners.
  ApplicationInformationViewModel& operator=(
      ApplicationInformationViewModel&&) = delete;
