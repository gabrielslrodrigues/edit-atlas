...
void ApplicationMenuBar::BuildUi(
  ...
  SetAutomationIdentifier(*export_logs_action_, u"exportDiagnosticLogsAction");
  ...
  SetAutomationIdentifier(*light_appearance_action_, u"lightAppearanceAction");
  SetAutomationIdentifier(*dark_appearance_action_, u"darkAppearanceAction");
...
void ApplicationMenuBar::UpdateRecentFilesMenu(void) {
  ...
  for (const auto& path : recent_files) {
    ...
    SetAutomationIdentifier(*action,
                            QStringLiteral("recentFileAction%1").arg(index));
