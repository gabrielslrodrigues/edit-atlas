...
[[nodiscard]] formats::xlsx::WorkbookLanguage WorkbookLanguageFor(
    presentation::ApplicationLanguage language) noexcept {
  switch (language) {
...
SpreadsheetExportOptionsDialog::SpreadsheetExportOptionsDialog(
  ...
  workbook_language_->addItem(
      ...
      static_cast<int>(formats::xlsx::WorkbookLanguage::kBrazilianPortuguese));
  ...
  continue_ = buttons->addButton(tr("Continue"), QDialogButtonBox::AcceptRole);
...
std::vector<core::MetadataEntry> SpreadsheetExportOptionsDialog::Options(
    void) const {
