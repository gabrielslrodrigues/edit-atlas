...
class TimelineTemplateService final {
 public:
  ...
  [[nodiscard]] const TimelineTemplate* Find(std::string_view identifier) const;

  /// Creates and persists a new template from current frontend state.
  [[nodiscard]] TimelineTemplateResult Create(
  ...
  [[nodiscard]] TimelineTemplateResult Update(
  ...
  [[nodiscard]] TimelineTemplateMutationResult Remove(
      std::string_view identifier);

 private:
  [[nodiscard]] std::expected<void, TimelineTemplateFailure> ValidateName(
