...
#ifndef EDIT_ATLAS_TESTS_UNIT_CORE_FORMAT_TEST_DOUBLES_HPP_
#define EDIT_ATLAS_TESTS_UNIT_CORE_FORMAT_TEST_DOUBLES_HPP_
...
class StubImporter final : public Importer {
 public:
  ...
  [[nodiscard]] const FormatDescriptor& descriptor(
  ...
  [[nodiscard]] int import_count(void) const noexcept { return import_count_; }
...
class StubExporter final : public Exporter {
 public:
  ...
  [[nodiscard]] int export_count(void) const noexcept { return export_count_; }
...
#endif  // EDIT_ATLAS_TESTS_UNIT_CORE_FORMAT_TEST_DOUBLES_HPP_
