...
[[nodiscard]] core::EditEvent Event(std::string identifier, std::string reel,
                                    core::TrackKind track_kind,
                                    std::string track_identifier,
                                    core::EditType edit_type,
                                    std::string clip_name, std::string comment,
      ...
      .events =
          {
              ...
              Event("003", "AX", core::TrackKind::kVideo, "V2",
                    core::EditType::kWipe, "Insert", "Ação final closeup", 96),
          },
      .metadata = {},
      .diagnostics = {},
      .provenance = std::nullopt,
