...
function(edit_atlas_define_default_application target)
    if(NOT TARGET "${target}")
        message(FATAL_ERROR "Unknown default application target: ${target}")
    endif()
    ...
    elseif(WIN32)
        ...
        message(
            FATAL_ERROR
            "Default application deployment is unsupported on this platform."
        )
    endif()
    install(
